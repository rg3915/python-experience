'''
Problema 1.5 - Dados um número inteiro n >= 0, e uma sequência com n inteiros,
determinar a soma dos inteiros positivos e a soma dos inteiros negativos da
sequência. Por exemplo, para a sequência 6, -2, 7, 0, -5, 8, 4 o programa deve
escrever o número 25 e -7.
